...
$db = JFactory::getDbo();
$query = "SELECT * FROM #__virtuemart_image WHERE productid ='{$this->product->virtuemart_product_id}' group by colorid";
$db->setQuery($query);
...
if($this->product->virtuemart_product_id)
	$tabarray['color'] = 'COM_VIRTUEMART_PRODUCT_FORM_PRODUCT_COLOR_TAB';
if(count($colors))
	$tabarray['quanity'] = 'COM_VIRTUEMART_PRODUCT_FORM_PRODUCT_QUANTITY_TAB';
