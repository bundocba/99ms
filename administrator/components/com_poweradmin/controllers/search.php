		...
		foreach ($coverages as $coverage) {
			...
			if ($coverage == 'zoo') {
				if (in_array('com_zoo', $installedComponents)) {
					$components['com_zoo'] = array('com_zoo', 'com_zoo_categories');
				}
				else {
					continue;
				}
			...
			if ($coverage == 'easyblog') {
				if (in_array('com_easyblog', $installedComponents)) {
					$components['com_easyblog'] = array('com_easyblog', 'com_easyblog_categories');
				}
				else {
					continue;
				}
			...
			if ($coverage == 'virtuemart') {
				if (in_array('com_virtuemart', $installedComponents)) {
					$components['com_virtuemart'] = array('com_virtuemart', 'com_virtuemart_categories');
				}
				else {
					continue;
				}
