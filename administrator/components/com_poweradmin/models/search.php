	...
	private function _getTableMapping ($name) {
		...
		$mappings = array(
			...
			'com_zoo' => array(
					...
					'icon'	=> 'cls:icon-16-article',
					'fields' => array('title' => '{name}', 'description' => ''),
					'link'	=> 'index.php?option=com_zoo&controller=item&changeapp=1&task=edit&cid[]={id}',					
			),
			...
			'com_easyblog' => array(
					'name'	=> '#__easyblog_post',
					'lookup' => array('title'),
					'icon'	=> 'cls:icon-16-article',
					'fields' => array('title' => '{title}', 'description' => ''),
					'link'	=> 'index.php?option=com_easyblog&c=blogs&task=edit&blogid={id}',					
			),

			'com_easyblog_categories' => array(
					'name'	=> '#__easyblog_category',
					'lookup' => array('title'),
					'icon'	=> 'cls:icon-16-category',
					'fields' => array('title' => '{title}', 'description' => ''),
					'link'	=> 'index.php?option=com_easyblog&c=category&task=edit&catid={id}',
			),

			'com_virtuemart' => array(
					'name'	=> '#__virtuemart_products' . $vmLang,
					'lookup' => array('product_name'),
					'icon'	=> 'cls:icon-16-category',
					'fields' => array('title' => '{product_name}', 'description' => '{product_s_desc}'),
					'link'	=> 'index.php?option=com_virtuemart&view=product&task=edit&virtuemart_product_id={virtuemart_product_id}',
			),
				
			'com_virtuemart_categories' => array(
					'name'	=> '#__virtuemart_categories' . $vmLang,
					'lookup' => array('category_name'),
					'icon'	=> 'cls:icon-16-category',
					'fields' => array('title' => '{category_name}', 'description' => '{category_description}'),
					'link'	=> 'index.php?option=com_virtuemart&view=category&task=edit&cid={virtuemart_category_id}',
			)
