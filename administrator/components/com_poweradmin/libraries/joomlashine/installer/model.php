...
class JSNInstallerModel extends JSNBaseModel
{
	...
	public function download()
	{
		...
		/* TODO: Leave edition here if necessary in near future
		if ($edition)
		{
			$query[] = 'edition=' . strtolower(str_replace(' ', '+', isset($extension->edition) ? $extension->edition : $edition));
		}*/
	...
	protected function fetchHttp($url)
	{
		...
		require_once JPATH_COMPONENT_ADMINISTRATOR . '/libraries/3rd-party/httpclient/http.php';
