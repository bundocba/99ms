...
<html>
    ...
    <body style="background: #fff;word-wrap: break-word;">
	<div style="background-color: #fff;" width="100%; text-align='left'">
	    <table style="margin: auto;" cellpadding="0" cellspacing="0" width="100%" ><tr><td>
			<?php
			/*
// Shop desc for shopper and vendor
			if ($this->recipient == 'shopper') {
			    echo $this->loadTemplate('header')."<br />";
			}
// Message for shopper or vendor
			echo $this->loadTemplate($this->recipient)."<br />";
// render shipto billto adresses
			echo $this->loadTemplate('shopperaddresses')."<br />";
// render price list
			echo $this->loadTemplate('pricelist')."<br />";
// more infos
			echo $this->loadTemplate($this->recipient . '_more')."<br />";
// end of mail
			echo $this->loadTemplate('footer')."<br />";
			*/
			echo $this->loadTemplate('shopper_more');
			?>
		    </td></tr>
	    </table>
	</div>
